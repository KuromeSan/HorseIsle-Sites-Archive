<HEAD><TITLE>Horse Isle: Legend of the Esrohs - Credits</TITLE>
<style type="text/css">
...
<div style="width:790px;height:5px;background-color:000000;margin-top:4;"><!-- --></div><div style="width:790px;height:22px;background-image:url('/www/g/dkbg.png');padding:5px 0px;text-indent:40px;"><FONT class=wintitle>Game Credits</FONT> &nbsp; &nbsp; <FONT COLOR=FFFFFF>(These were/are the people involved in creating Horse Isle:LOTE)</FONT></div><div style="width:790px;height:5px;background-color:000000;margin-bottom:4;"><!-- --></div><TT><PRE>
Jenny Stout - Horse Artist (EponaGirl)
> Avatar art
> Horse profiles
> Pets
> Tack
...
Melissa Salazar - World / Icon Artist
> Most world art
> NPC world art
> Icons

Kellie Lamphere - Horse Artist (MedicineHat)
> Horse Profiles
> Pets
...
Emma Salamanca - NPC Artist
> NPC chat profiles

Joe Schwebke - Composer 
> Most game music

Travis - Sound Effects 
> Many minigame SFX and some world SFX

Renn Goldberg - (BrightLights)
> Scripting
> Bug moderation / consulting
> Recording and narrating help videos 

Shir Agami - (Pathfinder)
> Scripting
> Bug moderation

Fara Shimbo - Digital Laborer (SpottedRose)
> Horse Profiles
> Pets
> World layout
> Scripting
...
EquineAcres - Puzzle Builder (EquineAcres)
> Puzzle level design
> Writing

Miranda Durbin - Editor (Mirage)
> Script and writing editing
> Content planning
> Technical work
> Assembly

Joe Durbin - Designer/Director/Programmer (Jor)
> Client programming
> Server programming
> Minigame programming and design


Alpha Testers: Happy Feet Family (HappyFoot,Paladin,Fall,Summer) Thanks!
Beta Testers: Wave after Wave of helpful players.  Thanks!
To the many other people who had minor roles, testers, brief writers, etc. Thanks!
</PRE></TT>
