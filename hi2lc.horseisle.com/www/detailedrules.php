...
4] To contact Admin please go to the Horse Isle MAIN page (hi2lc.horseisle.com) and click the "Help" button at the top, then start a Support Issue.<br>
...
9] No advertising for anything that is considered trading on a promise.  This includes, but is not limited to, trading between any of the Horse Isle games (1, Eternal or LifeCycle), paying a player to flute a horse for you, selling an unborn/unweaned foal, etc. (See also "Trading on a Promise")<br>
...
1] Please do not ask another player to buy a horse that is NOT set under the "<b>Sell for good price</b>" or "<b>Want to sell</b>" tags.
2] 2] Horses marked "<b>Not selling now</b>" may or may not be for sale. If a player does not want to sell now, please respect that, and wait for the horse to come available.<br>
...
3] Remember to do everything in moderation, a few hours per day will suffice, and at the same time give you a more enjoyable game (Absence makes the heart grow fonder).<br>
4] This is the reason we limit playtime to 18 hours per 36 hour time period. (See Help section by clicking Help, then SUPPORT -> Misc -> 18 hour safety time limit)<p>
...
<b>Foals</b><br>
1] You are not allowed to sell unborn or unweaned foals.  These cannot be traded yet, so any selling and exchanging of payment would be trading on a promise and is not allowed.<br>
2] Taking offers on foals is allowed, however, nothing can be done about a player possibly backing out of the deal should they change their mind down the line.  This is something Horse Isle will not be able to enforce.  If you want to avoid this possibility, wait until the foal is born and ready to be traded.<p>

<b>Forums</b><br>
1] There are six forums: Bugs, Community Help, Game, Horses, General and Breeding.<br>
...
<b>Help</b><br>
1] If you need help please always remember to refer to the Help pages provided to you on the Horse Isle MAIN page (hi2lc.horseisle.com) first.<br>
...
4] You should change your password frequently in order to prevent hacking, you can change it by going to hi2lc.horseisle.com, clicking on the"<b> Account</b>" button near the top of the website. Scroll down to the bottom and click "<A href=http://hi2lc.horseisle.com/www/accountchangepassword.php>CHANGE PASSWORD</A>".<br>
...
4] If you wish to RP stallion/mare, nothing more than "gives birth" is allowed.  No mating is allowed.  Nothing specific or graphic is allowed.  No fighting between horses is allowed.<br>
...
4] If you agree to train a horse for another player and receive money up front, you must either complete the training as agreed, or cancel the lease and refund <b>all</b> the funds given to you.  If you do not fulfill your end of the deal, but keep the money, you are stealing and will be banned.<br>
5] If a player trains a horse for you, but you wait to pay until after the training is done, you must pay the agreed upon amount when the training is completed.  If you do not, you will be banned.<br>
6] If you have another player Experience train your horse, it is highly advised to use the Experience Training Contract.  This is set up so both players do not lose money in the end.  If a player refuses to use this system, it is advisable to not make a deal with them.  If you do not use this system, it is considered trading on a promise, and the above statements apply.<p>
...
1] Trading between the Horse Isle games (Secret Land of Horses/HI1, Legend of the Esrohs/HI2 Eternal and LifeCycle) is not recommended or endorsed by Horse Isle.<br>
...
3] Trading on a promise includes, but is not limited to: trading between HI1, HI2:Eternal or HI2:LifeCycle, boarding a horse with another player not using the leasing system, lending items/pets/money, trading an item/horse/money with the player promising to pay you back later, having a horse trained without using the in-game system or selling an unborn/unweaned foal.<br>
