<HEAD><TITLE>Horse Isle: Legend of the Esrohs - New Player Guide</TITLE>
<style type="text/css">
...
<div style="width:790px;height:5px;background-color:000000;margin-top:4;"><!-- --></div><div style="width:790px;height:22px;background-image:url('/www/g/dkbg.png');padding:5px 0px;text-indent:40px;"><FONT class=wintitle>How-to Videos</FONT> &nbsp; &nbsp; <FONT COLOR=FFFFFF>(The videos are narrated, so be sure your sound is on.)</FONT></div><div style="width:790px;height:5px;background-color:000000;margin-bottom:4;"><!-- --></div>
<CENTER>
<HR>
</CENTER><B>Beginner Help Videos:</B><BR><LI>[<A HREF=?V=5>PLAY</A>] Welcome Isle Walkthrough: Completing your first quest.</LI><LI>[<A HREF=?V=10>PLAY</A>] General Gameplay: Overview of Horse Isle: Legend of the Esrohs.</LI><LI>[<A HREF=?V=15>PLAY</A>] Horse Isle Money: Ways of earning some money.</LI><LI>[<A HREF=?V=20>PLAY</A>] Horse Capture: Capturing a wild horse.</LI><LI>[<A HREF=?V=30>PLAY</A>] Naming your horse: How to name your horse within dictionary rules.</LI><LI>[<A HREF=?V=35>PLAY</A>] Chatting: Different types and how the filter works.</LI><LI>[<A HREF=?V=38>PLAY</A>] Competitions: Competing in the various Arenas.</LI><LI>[<A HREF=?V=40>PLAY</A>] Library and BBB: How to view available horses.</LI><LI>[<A HREF=?V=42>PLAY</A>] Community Board: How to find valuable information.</LI><LI>[<A HREF=?V=45>PLAY</A>] Crafting: making things yourself!</LI><BR><B>Advanced Help Videos:</B><BR><LI>[<A HREF=?V=50>PLAY</A>] Game Speed Improvements: How to speed up the game.</LI><LI>[<A HREF=?V=58>PLAY</A>] Subscription Tokens: How to obtain and use.</LI><LI>[<A HREF=?V=60>PLAY</A>] Horse Tokens: How to use and available options.</LI><LI>[<A HREF=?V=62>PLAY</A>] Super Horse Tokens: How to use and additional options.</LI><LI>[<A HREF=?V=65>PLAY</A>] Club Tokens: How to use and available options.</LI><LI>[<A HREF=?V=80>PLAY</A>] Art Kit: Creating custom profile and rump art.</LI><LI>[<A HREF=?V=90>PLAY</A>] Competition Stats: What they rely on and how computed.</LI><LI>[<A HREF=?V=95>PLAY</A>] Breeding: All about breeding.</LI><HR>
</div>
<BR style='clear:both'>
